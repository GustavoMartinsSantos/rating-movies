...
router.post('/edit-profile', [auth, multer(multerConfig).single('image')], userController.update)
router.get('/edit-profile/email', auth, userController.showEmail)
router.post('/edit-profile/email', auth, userController.updateEmail)
